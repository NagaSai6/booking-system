...
document.getElementById("continueButton").addEventListener("click", function () {
  ...
  var categoryName = document.getElementById("categoryName").value.toLowerCase();
  var imageLink = document.getElementById("inputImageSourceLink").value;
  var element = document.getElementById("generatedInputFields");
...
function generateInputs(num) {
  var divElement = document.getElementById("generatedInputFields");
...
function formatData(n, c, i) {
  ...
  for (var a = 1; a <= parseInt(n); a++) {
    var dataObject = {};
    var param = "instrument" + a;
    var inputData = document.getElementById(param).value.toLowerCase();
    dataObject.category = c.toLowerCase();
    dataObject.instrumentName = inputData;
    dataObject.image = i; // console.log(dataObject);
...
function manageData(data) {
  var dataFormatted = toObject(data);
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/add-instruments", dataFormatted).then(function (res) {
    if (res.data.success == "successfully added") {
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.closeMethod) = 'fadeOut';
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.closeDuration) = 300;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.closeEasing) = 'swing';
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.newestOnTop) = true;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.preventDuplicates) = true;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.timeOut) = 5000;
      toastr__WEBPACK_IMPORTED_MODULE_1___default().success('Success', 'Instrument Added Succesfully');
    ...
    if (res.data.success == "Failed to add") {
      ...
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.preventDuplicates) = true;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.timeOut) = 5000;
      return toastr__WEBPACK_IMPORTED_MODULE_1___default().error('Error', 'Failed to Instrument');
    }
    ...
    if (res.data.success == "category already exist") {
      ...
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.newestOnTop) = true;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.preventDuplicates) = true;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.timeOut) = 7000;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.positionClass) = "toast-top-center";
      return toastr__WEBPACK_IMPORTED_MODULE_1___default().error('Error', 'Category Already Exists. Try Updating');
    }
  });
}
