...
$("#attach-available-items").on("click", "button", function (e) {
  var dataOfInstrument = JSON.parse(this.dataset.instrument);
...
function initBook(d, qd, qs, qe) {
  d.queryDate = qd;
  d.queryStart = qs;
  d.queryEnd = qe; //  console.log(d);

  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/user/book-instrument", d).then(function (res) {
    var parsedResponse = res.data.message;
    console.log(parsedResponse);

    if (parsedResponse === "Successfully Booked") {
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.closeButton) = false;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.progressBar) = true;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.positionClass) = "toast-top-right";
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.showDuration) = 300;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.hideDuration) = 1000;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.timeOut) = 5000;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.extendedTimeOut) = 1000;
      (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.hideEasing) = "linear";
      return toastr__WEBPACK_IMPORTED_MODULE_1___default().success("Instrument Successfully booked ,Check your Inbox", "Success");
    } else {
      ...
      return toastr__WEBPACK_IMPORTED_MODULE_1___default().error("You could have been faster , This item has booked just now", "Oops");
    }
  });
}
})();
