...
$("#AdminAddInstrument").on("click", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var addSingleInstrument, _yield$Swal$fire, formValues;

    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            addSingleInstrument = JSON.parse(e.currentTarget.dataset.addinstrument);
            _context.next = 3;
            return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              title: 'Instrument Name',
              html: "<input value=\"".concat(addSingleInstrument.category, "\" disabled id=\"swal-input1\" class=\"swal2-input\">") + "<input value=\"".concat(addSingleInstrument.image, "\" disabled id=\"swal-input2\" class=\"swal2-input\">") + "<input placeholder=\"instrumentName\" id=\"swal-input3\" class=\"swal2-input\">",
              focusConfirm: false,
...
function sendDeleteRequest(id) {
  var data = {};
  data.id = id;
  axios__WEBPACK_IMPORTED_MODULE_2___default().post("/admin/delete-instruments", data).then(function (res) {
...
function triggerAddSingleInstrument(data) {
  var FormattedData = toObject(JSON.parse(data));
  console.log(FormattedData);
  axios__WEBPACK_IMPORTED_MODULE_2___default().post('/admin/add-single-instrument', FormattedData).then(function (res) {
